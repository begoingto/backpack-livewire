<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <div 
                    class="drag-drop w-100 vh-75 d-flex flex-column justify-content-center p-4 align-items-center @error('file') border-danger   @enderror"
                ...
                <form action="#">
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-4 col-form-label">Column Label<sup class="text-danger">*</sup></label>
                        <div class="col-sm-8">
                    ...
                    <hr>
                    <button class="btn btn-primary float-right"><i class="la la-cloud-upload la-lg"></i> Import</button>
                </form>
            </div>
        </div>
    </div>
